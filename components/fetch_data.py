...
from components.retrieve_data import *
...
class FetchData():
    ...
    def reassignment_of_values(self) -> None:
        ...
        my_list = [value["data"] for value in self.final_result.values()]
    ...
    def upload_to_local(self, filename: str) -> None:
        ...
        directory_path = r"D:\python_project\json"
